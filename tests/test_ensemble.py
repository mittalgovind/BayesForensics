...
@pytest.fixture
def ensemble_model():
    return SFPDeepEnsemble(SFP("vanilla", c_filters=(32, 32, 32, 32),
...
@pytest.fixture
def dataset():
    return Dataset(data_directory='/scratch/jms1595/neural-imaging-dev/data/rgb/native12k',
                   load='y', n_images=10, v_images=10, randomize=69)

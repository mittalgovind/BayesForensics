...
def main():
    ...
    plots = OrderedDict()
    if "jpg" in args.codec:
        plots["jpg"] = ("jpeg.csv", {})
    if "jp2" in args.codec:
        plots["jp2"] = ("jpeg2000.csv", {})
    if "bpg" in args.codec:
        plots["bpg"] = ("bpg.csv", {})
    if "dcn" in args.codec:
    ...
    if args.output is not None:
        ...
        of_name = os.path.join(
            args.output, "tradeoff_{}_{}_{}.pdf".format(dset, args.metric, args.plot)
        )

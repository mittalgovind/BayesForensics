...
scales = (0.25, 1.0)  # (0.8, 1.4), (1.5, 2.0)
epochs = 10000
batch_multip = 4
batch_size = 10
patch_size = 128
    ...
    for epoch in range(epochs):
        ...
        for batch_id in range(n_batches):
            ...
            batch_yy = tf.image.resize(
                batch_y, [int(sf * patch_size), int(sf * patch_size)], method=method
            )
...
model.save_weights("model_weights/bayesian_scaleFactor_multAlgo.h5")
